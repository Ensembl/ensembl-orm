...
my $VIRTUAL_COLUMNS = {
  ...
  'upload'            => [qw(file filename filesize name code md5 format species assembly assemblies share_id analyses browser_switches renderers style display nearest timestamp cloned_from no_attach)],
