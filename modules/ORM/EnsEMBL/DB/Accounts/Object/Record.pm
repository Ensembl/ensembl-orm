...
my $VIRTUAL_COLUMNS = {
  ...
  'upload'            => [qw(filename filesize name code md5 format species assembly share_id analyses browser_switches style display nearest timestamp cloned_from no_attach)],
