...
package ORM::EnsEMBL::DB::Session::Object::ShareURL;

### NAME: ORM::EnsEMBL::DB::Session::Object::ShareURL
### ORM class for the share_url table in session db
